...
'''
En este test no solo leemos el thrust en PWM y voltaje, sino tambien
extraemos las velocidades, aceleraciones y matriz de rotación del drone
a partir de la posición y orientación que nos da el Optitrack 
La idea es tener una estimación más completa del estado del drone para usarlo luego.
'''
